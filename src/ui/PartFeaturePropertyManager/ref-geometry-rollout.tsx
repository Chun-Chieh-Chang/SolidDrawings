        ...
        <div className="space-y-3">
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full bg-white border border-slate-300 rounded px-2 py-1 text-[12px] font-bold"
            >
              <option value="planes">3 Planes/Faces</option>
              <option value="axes">2 Axes (2 Axis)</option>
              <option value="points">3 Points (3 Points)</option>
              <option value="origin">Origin + 2 Axes</option>
            </select>
          </div>
