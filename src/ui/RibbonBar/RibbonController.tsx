      ...
      <div className="flex-1 flex items-center px-6 py-2 gap-2 overflow-x-auto overflow-y-hidden bg-surface"> 
        {activeTab === 'DRAWING' ? (
          ...
          <div className="flex items-center gap-2 h-full animate-in fade-in slide-in-from-left-2 duration-300">
            ...
            {onOpenScadPanel && (
              <button onClick={onOpenScadPanel} className="flex flex-col items-center justify-center gap-0.5 px-3 h-[78px] min-w-[75px] transition-all border border-transparent hover:bg-white hover:border-[#A0A0A0] active:bg-slate-100 group" title="OpenSCAD / Import STL / Text-to-CAD">
                <div className="w-10 h-10 flex items-center justify-center text-emerald-700 transition-transform group-hover:scale-110">
                ...
                <span className="text-[10px] font-bold text-slate-800 leading-none uppercase">OpenSCAD</span>
              </button>
            )}
            <div className="w-[1px] h-10 bg-border/50 mx-1" />
            <button onClick={() => { 
            ...
            <button
              onClick={() => { appliedEdgeFeatureRef.current = null; setActiveTab('FEATURES'); if (skipWizardIfRobotWorking()) { setPendingFeatureCommand('CHAMFER'); setSelectedTopology(null); } }}
            ...
            <button
              onClick={() => { appliedEdgeFeatureRef.current = null; setActiveTab('FEATURES'); if (skipWizardIfRobotWorking()) { setPendingFeatureCommand('THICKEN'); setSelectedTopology(null); } }}
