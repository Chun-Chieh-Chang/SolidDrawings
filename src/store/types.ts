...
export const DEFAULT_RIBBON_LAYOUT: RibbonLayout = {
  FEATURES: ['EXTRUDE', 'REVOLVE', 'EXTRUDE_CUT', 'REVOLVED_CUT', 'SWEEP', 'LOFT', 'WRAP', 'FILLET', 'CHAMFER', 'INTERSECT', 'MIRROR', 'PATTERN', 'SHELL', 'DOME', 'DRAFT', 'REFERENCE_PLANE', 'REFERENCE_AXIS', 'REFERENCE_POINT', 'REFERENCE_COORDINATE_SYSTEM', 'HOLE_WIZARD'],
